...
require (
	...
	github.com/fission-codes/kubo-car-mirror v0.0.0-20230124171924-c10482a7df2d
...
require (
	...
	github.com/fission-codes/go-car-mirror v0.0.0-20230124131727-eb8927b2a1c4 // indirect
