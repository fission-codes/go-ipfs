...
require (
	...
	github.com/fission-codes/kubo-car-mirror v0.0.0-20230316185312-b0bce69e8db2
...
require (
	...
	github.com/fission-codes/go-car-mirror v0.0.0-20230316184453-ee0e00ba4a18 // indirect
