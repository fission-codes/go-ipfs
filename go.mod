...
require (
	...
	github.com/fission-codes/kubo-car-mirror v0.0.0-20230313161523-b8d30df89fa7
...
require (
	...
	github.com/fission-codes/go-car-mirror v0.0.0-20230313160033-69ac9f004aed // indirect
